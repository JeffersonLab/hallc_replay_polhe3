...
T->SetBranchAddress("P.ngcer.goodAdcTdcDiffTime",&ngcer_goodAdcTdcDiffTime);  // events that pass the detector time window cuts
 ...
 T->SetBranchAddress("P.cal.etracknorm", &cal_etracknorm); // shower + preshower energy (I'm not exactly sure how these are "normalized" but these are the variables Brad and Xiaochao wanted me to use)
...
-- P.cal.etottracknorm>0.8 to choose electrons.

-- P.gtr.dp > -10 && P.gtr.dp < 22.

-- timing window cuts (P.ngcer.goodAdcTdcDiffTime) (already set in the corresponding parameter file in hallc_replay )
...
//// Declare histos and fits. 
 ...
 //TH2F *ng_xyCer[5]; // non-physical cuts applied
 ...
 TH1F *TotalCalEnergyRAW; // before non-physical cuts
 ...
 TF1 *gausFitAmp1, *gausFitAmp2, *gausFitAmp3, *gausFitAmp4;
 TF1 *gausFitInt1, *gausFitInt2, *gausFitInt3, *gausFitInt4;
 TF1 *poisFitInt1, *poisFitInt2, *poisFitInt3, *poisFitInt4;
...
//Make shower vs preshower energy 2D histo
 ...
 TotalCalEnergy=new TH1F(Form("total energy etracknorm run #%s",run_num),Form("total energy etracknorm run #%s",run_num),40,0,0.2);
 ShowerEnergy=new TH1F(Form("Shower Energy (etracknorm - eprtracknorm) run #%s",run_num),Form("Shower Energy (etracknorm - eprtracknorm) run #%s",run_num),40,0,0.2);
 PreshowerEnergy=new TH1F(Form("Preshower Energy eprtracknorm run #%s",run_num),Form("Preshower Energy eprtracknorm run #%s",run_num),40,0,0.2);
 ...
 // ng_xyCerRAW=new TH2F(Form("XatCer vs YatCer RAW run #%s",run_num), Form("XatCer vs YatCer RAW run # %s",run_num),400, -40, 40, 400, -40, 40);
 ...
 for(Int_t i=1; i<npmt+1; i++){
   ...
   TString titlePulseAmp=Form("PMT%d: SHMS NGCER goodAdcPulseAmp, Run %s",i,run_num);
   TString namePulseInt=Form("hNcerPulseInt%d",i);  
   TString titlePulseInt=Form("PMT%d: SHMS NGCER goodAdcPulseInt, Run %s",i,run_num);

   TString namePulseAmp_nocut=Form("hNcerPulseAmp%d nocut",i);  
   TString titlePulseAmp_nocut=Form("PMT%d: SHMS NGCER goodAdcPulseAmp, Run %s",i,run_num);
   TString namePulseInt_nocut=Form("hNcerPulseInt%d nocut",i);  
   TString titlePulseInt_nocut=Form("PMT%d: SHMS NGCER goodAdcPulseInt nocut, Run %s",i,run_num);

   TString namePulseAmp_Calcut=Form("hNcerPulseAmp%d Calcut",i);  
   TString titlePulseAmp_Calcut=Form("PMT%d: SHMS NGCER goodAdcPulseAmp Cal cut, Run %s",i,run_num);
   TString namePulseInt_Calcut=Form("hNcerPulseInt%d Calcut",i);  
   TString titlePulseInt_Calcut=Form("PMT%d: SHMS NGCER goodAdcPulseInt Cal cut, Run %s",i,run_num);

   TString namePulseAmp_gtrcut=Form("hNcerPulseAmp%d gtrcut",i);  
   TString titlePulseAmp_gtrcut=Form("PMT%d: SHMS NGCER goodAdcPulseAmp gtr cut, Run %s",i,run_num);
   TString namePulseInt_gtrcut=Form("hNcerPulseInt%d gtrcut",i);  
   TString titlePulseInt_gtrcut=Form("PMT%d: SHMS NGCER goodAdcPulseInt gtr cut, Run %s",i,run_num);

   TString namePulseAmp_xycut=Form("hNcerPulseAmp%d xycut",i);  
   TString titlePulseAmp_xycut=Form("PMT%d: SHMS NGCER goodAdcPulseAmp xy cut Run %s",i,run_num);
   TString namePulseInt_xycut=Form("hNcerPulseInt%d xycut",i);  
   TString titlePulseInt_xycut=Form("PMT%d: SHMS NGCER goodAdcPulseInt xy cut Run %s",i,run_num);

   TString namePulseAmp_allcut=Form("hNcerPulseAmp%d allcut",i);  
   TString titlePulseAmp_allcut=Form("PMT%d: SHMS NGCER goodAdcPulseAmp Cal cut,gtr cut, xy cut Run %s",i,run_num);
   TString namePulseInt_allcut=Form("hNcerPulseInt%d allcut",i);  
   TString titlePulseInt_allcut=Form("PMT%d: SHMS NGCER goodAdcPulseInt Cal cut, gtr cut, xy cut Run %s",i,run_num);
   
   TString namePulseAmpRAW=Form("hNcerPulseAmp%d RAW",i);  
   TString titlePulseAmpRAW=Form("PMT%d: SHMS NGCER goodAdcPulseAmp RAW, Run %s",i,run_num);
   TString namePulseIntRAW=Form("hNcerPulseInt%d RAW",i);  
   TString titlePulseIntRAW=Form("PMT%d: SHMS NGCER goodAdcPulseInt RAW, Run %s",i,run_num);
   ...
   //  ng_xyCerRaw[i]=new TH2F(Form("XatCer vs YatCer Raw PMT%d %s",i,run_num), Form("XatCer vs YatCer Raw PMT%d %s",i,run_num),400, -40, 40, 400, -40, 40);
   ng_xyCer_nocut[i]=new TH2F(Form("XatCer vs YatCer PMT%d nocut %s",i,run_num), Form("XatCer vs YatCer PMT%d non-physical cuts applied, no other cuts %s",i,run_num),400, -40, 40, 400, -40, 40);
   ng_xyCer_SinglePmt[i]=new TH2F(Form("XatCer vs YatCer PMT%d SinglePmt %s",i,run_num), Form("XatCer vs YatCer PMT%d  SinglePmt %s",i,run_num),400, -40, 40, 400, -40, 40);
   ng_xyCer_SinglePmt_Calcut[i]=new TH2F(Form("XatCer vs YatCer PMT%d SinglePmt Cal cut %s",i,run_num), Form("YatCer vs XatCer PMT%d SinglePmt Calcut %s",i,run_num),400, -40, 40, 400, -40, 40);

   XatCerHisto_nocut[i] =new TH1F(Form("XatCerHisto_nocut PMT%d %s",i,run_num), Form("XatCerHisto PMT%d nocut %s",i,run_num),400,-40,40);
   YatCerHisto_nocut[i] =new TH1F(Form("YatCerHisto_nocut PMT%d %s",i,run_num), Form("YatCerHisto PMT%d nocut %s",i,run_num),400,-40,40);

   XatCerHisto_SinglePmt[i] =new TH1F(Form("XatCerHisto_SinglePmt PMT%d Single%s",i,run_num), Form("XatCerHisto PMT%d SinglePmt %s",i,run_num),400,-40,40);
   ...
   XatCerHisto_SinglePmt_Calcut[i] =new TH1F(Form("XatCerHisto_SinglePmt_Calcut PMT%d %s",i,run_num), Form("XatCerHisto SinglePmt Cal cut PMT%d %s",i,run_num),400,-40,40);
   ...
   XatCerHistoRAW[i] =new TH1F(Form("XatCerHisto PMT%d RAW %s",i,run_num), Form("XatCerHisto PMT%d RAW %s",i,run_num),400,-40,40);
 ...
 // y-axis
 cal_y_cut_lower= 0.8; //set to 0 if you don't want to cut the ngcer data. (0.95-1.15 for run 9740) (0-0.3 for 9573) (0.1-0.6 for 10337)
 cal_y_cut_upper=1.4; //set to a big number (ex. 2) if you don't want a cut
 // x- axis
 cal_x_cut_lower=0.25; //set to 0 if you don't want to cut the ngcer data. (0.45-0.75 for run 9740) (0-0.07 for 9573) (0.025-0.06 for 10337)
 cal_x_cut_upper=1.1; //set to a big number (ex. 2) if you don't want a cut   

 // XatCer, YatCer cuts
 Double_t XatCerCutLower[5]={-1000,0,0,-17,-13}; //Old code is counting from 1
 Double_t XatCerCutUpper[5]={-1000,5.5,3.8,-0.2,-1.0};
 Double_t YatCerCutLower[5]={-1000,0,-13.7,1.5,-16};// {FLAG, PMT1, PMT2, PMT3, PMT4}
 Double_t YatCerCutUpper[5]={-1000,12,-2.2,16,0};


//declare fits for 1D histos. Change as desired. 
 Int_t FitAmpMinArray[5]={-1000,120,100,120,100}; // {flag, PMT1, PMT2, PMT3, PMT4} Where to start the Amp fits for each PMT
 Int_t FitAmpMaxArray[5]={-1000, 280,280,280,280}; // {flag, PMT1, PMT2, PMT3, PMT4} Where to end the Amp fits

 Int_t FitIntMinArray[5]={-1000,30,20,32,25}; //{flag, PMT1, PMT2, PMT3, PMT4} Where to start the Int fits
 Int_t FitIntMaxArray[5]={-1000,70,60,95,85};//{flag, PMT1, PMT2, PMT3, PMT4} Where to end the Int fits
 ...
 gausFitAmp3 = new TF1("gausFitAmp3", "gaus",FitAmpMinArray[3],FitAmpMaxArray[3]);// PMT 3
 gausFitInt3 = new TF1("gausFitInt3", "gaus",FitIntMinArray[3],FitIntMaxArray[3]);

 gausFitAmp4 = new TF1("gausFitAmp4", "gaus",FitAmpMinArray[4],FitAmpMaxArray[4]);// PMT 4
 gausFitInt4 = new TF1("gausFitInt4", "gaus",FitIntMinArray[4],FitIntMaxArray[4]);
...
poisFitInt3 = new TF1("poisFitInt3", "[0]*TMath::Power(([1]/[2]),(x/[2]))*(TMath::Exp(-([1]/[2])))/TMath::Gamma((x/[2])+1)",FitIntMinArray[3],FitIntMaxArray[3]);
 poisFitInt3->SetParameters(1000,44,7.9);
 poisFitInt4 = new TF1("poisFitInt4", "[0]*TMath::Power(([1]/[2]),(x/[2]))*(TMath::Exp(-([1]/[2])))/TMath::Gamma((x/[2])+1)",FitIntMinArray[4],FitIntMaxArray[4]);
 poisFitInt4->SetParameters(1000,44,7.9);
...
// Loop of entries in tree
 ...
 for(Long64_t ievent=0; ievent < nentries; ievent++){   //can be lowered for testing                       
   ...
   //ng_xyCerRaw->Fill(ngcer_YatCer, ngcer_XatCer);
   ...
   if(cal_eprtracknorm>0 && cal_etracknorm>0 && cal_eprtracknorm < cal_etracknorm && ngcer_YatCer != 0 && ngcer_XatCer != 0){ 
  ...
  // now we ARE CHECKING if only one PMT had a singnal 
   for (Int_t counterNew=1; counterNew< npmt+1; counterNew++){  // counting from 1
    //apply mutiplicity cuts
	 ...
	 ng_xyCer_SinglePmt[counterNew] -> Fill(ngcer_YatCer,ngcer_XatCer);
	 ...
	 //if(cal_etracknorm > 0.8){
	   if(cal_etracknorm > cal_y_cut_lower &&  cal_etracknorm < cal_y_cut_upper  && cal_eprtracknorm > cal_x_cut_lower && cal_eprtracknorm < cal_x_cut_upper){
	   ...
	   ng_xyCer_SinglePmt_Calcut[counterNew] -> Fill(ngcer_YatCer,ngcer_XatCer);
...
TCanvas *c2=new TCanvas("c2","c2",1000,700);
 ...
 TLine *cal_x_lower_line=new TLine(cal_x_cut_lower,0,cal_x_cut_lower,shwr_prshwr_yaxis_max); // x axis
  ...
  for (int i=1;i<5;i++){//counting from 1   
    ...
    YatCerLowerLines[i]= new TLine(YatCerCutLower[i],-40,YatCerCutLower[i],40);
    YatCerLowerLines[i]->SetLineStyle(9);
    YatCerLowerLines[i]->SetLineColor(kRed);
    YatCerLowerLines[i]->SetLineWidth(1);

    YatCerUpperLines[i]= new TLine(YatCerCutUpper[i],-40,YatCerCutUpper[i],40);
...
// graph the XY histos for each PMT without the shower cuts and without single pmt cuts, only non-physical cuts 
 ...
 for(Int_t counter = 1; counter < npmt+1; counter++){ 
   ...
   ng_xyCer_nocut[counter]->GetXaxis()->SetTitle("YatCer");
   ng_xyCer_nocut[counter]->GetYaxis()->SetTitle("XatCer");
 }
 c12-> Update();
...
// graph the xy plots without the shower cut and with single pmt cut
 ...
 for(Int_t counter = 1; counter < npmt+1; counter++){ 
   ...
   YatCerLowerLines[counter] -> Draw();
   YatCerUpperLines[counter] -> Draw();
   ng_xyCer_SinglePmt[counter]->GetXaxis()->SetTitle("YatCer");
   ng_xyCer_SinglePmt[counter]->GetYaxis()->SetTitle("XatCer");
 }
 c17-> Update();
...
TCanvas *c18=new TCanvas("c18","c18",1000,700);
 ...
 for(Int_t counter = 1; counter < npmt+1; counter++){ 
   ...
   ng_xyCer_SinglePmt_Calcut[counter]->Draw("colz");
    ...
    YatCerLowerLines[counter] -> Draw();
    YatCerUpperLines[counter] -> Draw();
   ng_xyCer_SinglePmt_Calcut[counter]->GetXaxis()->SetTitle("YatCer");
   ng_xyCer_SinglePmt_Calcut[counter]->GetYaxis()->SetTitle("XatCer");
 }
 c18-> Update();
...
TCanvas *c6=new TCanvas("c6","c6",1000,700);
 ...
 /* 
// graph shower vs preshower energy
TCanvas *c7=new TCanvas("c7","c7",1000,700);
 shwr_prshwr -> Draw("colz");
 c7-> Update();
 */
 ...
 /*
// graph total energy vs preshower energy in the calorimeter 
TCanvas *c14=new TCanvas("c14","c14",1000,700);
 shwr_prshwr3 -> Draw("colz");
 c14-> Update();
 */
 ...
 for(Int_t counter = 1; counter < npmt+1; counter++){ 
  c15->cd(counter);
  gPad->SetLogy();
  ng_goodAdcPulseAmp_allcut[counter] -> Fit(Form("gausFitAmp%d",counter),"R"); // comment out if you don't want to fit the ngcer   
  ng_goodAdcPulseAmp_allcut[counter]->SetLineColor(4);
  ng_goodAdcPulseAmp_allcut[counter]->SetLineWidth(2);
  ng_goodAdcPulseAmp_allcut[counter]->Draw("SAME");  
 }
 c15->Update();
 ...
 mean[3]=gausFitInt3-> GetParameter(1);
 sigma[3]=gausFitInt3->GetParameter(2);
 mean[4]=gausFitInt4-> GetParameter(1);
 sigma[4]=gausFitInt4->GetParameter(2);
 cout<<"***************************************************************************"<<endl;
